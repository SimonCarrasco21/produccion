    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card p-4 shadow-lg animate__animated animate__fadeInDown">
                ...
                <p class="text-center text-muted mb-4">Modifica la información del producto seleccionado, incluyendo su nombre, descripción, precio, stock y fecha de vencimiento.</p>
                ...
                <form action="{{ route('actualizarProducto', $producto->id) }}" method="POST">
                    ...
                    <div class="mb-3 position-relative">
                        <label for="descripcion" class="form-label"><span class="material-icons">description</span> Descripción:</label>
                    ...
                    <div class="mb-3 position-relative">
                        <label for="categoria" class="form-label"><span class="material-icons">category</span> Categoría:</label>
                    ...
                    <div class="mb-3 position-relative">
                        <label for="fecha_vencimiento" class="form-label"><span class="material-icons">event</span> Fecha de Vencimiento:</label>
                        <input type="date" class="form-control" name="fecha_vencimiento" id="fecha_vencimiento" value="{{ $producto->fecha_vencimiento }}">
                    </div>

                    <div class="d-flex justify-content-between mt-4">
                        <button type="submit" class="btn btn-success btn-lg w-45 shadow-sm animate__animated animate__pulse animate__infinite">Actualizar el Producto</button>
                        <a href="{{ route('agregar-producto') }}" class="btn btn-danger btn-lg w-45 shadow-sm">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
